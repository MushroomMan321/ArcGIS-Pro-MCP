...
{
    [McpServerTool(Name = "legend.get_state", ReadOnly = true), Description("Inspect an existing layout legend by layout and legend element IDs.")]
    public static Task<CallToolResult> GetState(
        BridgeInvoker bridge,
        [Description("Legend element ID from layout.get_state or object.registry.")] string elementId,
        [Description("Layout ID from layout.list or layout.get_state.")] string? layoutId = null,
    ...
    [McpServerTool(Name = "legend.set_visibility"), Description("Set visibility for an existing legend element.")]
    public static Task<CallToolResult> SetVisibility(
        BridgeInvoker bridge,
        [Description("Layout ID from layout.list or layout.get_state.")] string layoutId,
        [Description("Legend element ID from layout.get_state or object.registry.")] string elementId,
    ...
    [McpServerTool(Name = "legend.set_layout"), Description("Conservatively update legend placement, size, columns, fitting strategy, or title settings.")]
    ...
    [McpServerTool(Name = "legend.set_items"), Description("Show or hide existing legend items by layer ID or legend item name, without changing map layer visibility.")]
    ...
    [McpServerTool(Name = "legend.rename_items"), Description("Rename existing CIM legend item labels without changing layer names or renderer class labels.")]
    ...
    [McpServerTool(Name = "legend.apply_compact_style"), Description("Apply a restrained compact legend style without hiding items.")]
    ...
    [McpServerTool(Name = "legend.qa_preview"), Description("Export before/after layout previews around one conservative legend compacting edit.")]
