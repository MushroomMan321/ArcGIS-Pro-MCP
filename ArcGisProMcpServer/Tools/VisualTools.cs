...
{
    [McpServerTool(Name = "visual_capture_active_view", ReadOnly = true), Description("Capture the active ArcGIS Pro view as an image artifact.")]
    ...
    [McpServerTool(Name = "visual_export_active_map", ReadOnly = true), Description("Export the active ArcGIS Pro map view to a PNG image artifact.")]
    ...
    [McpServerTool(Name = "visual_export_layout_preview", ReadOnly = true), Description("Export a layout preview as an image artifact.")]
