...
{
    [McpServerTool(Name = "layer_list", ReadOnly = true), Description("List layers in the current ArcGIS Pro project, optionally filtered by map.")]
    ...
    [McpServerTool(Name = "layer_get_state", ReadOnly = true), Description("Inspect a layer by ID or name.")]
    ...
    [McpServerTool(Name = "layer_set_visibility"), Description("Set layer visibility by ID.")]
    ...
    [McpServerTool(Name = "layer_set_definition_query"), Description("Set a feature layer definition query by layer ID.")]
    ...
    [McpServerTool(Name = "layer_set_transparency"), Description("Set layer transparency by ID. 0 is opaque and 100 is fully transparent.")]
    ...
    [McpServerTool(Name = "layer_apply_symbology_from_layer"), Description("Apply symbology from a .lyrx layer file by layer ID.")]
    public static Task<CallToolResult> ApplySymbologyFromLayer(
        BridgeInvoker bridge,
        [Description("Target layer ID from layer_list or layer_get_state.")] string layerId,
